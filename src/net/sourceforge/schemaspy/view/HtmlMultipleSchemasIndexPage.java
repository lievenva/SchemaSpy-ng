...
public class HtmlMultipleSchemasIndexPage extends HtmlFormatter {
    ...
    private void writeHeader(String databaseName, DatabaseMetaData meta, int numberOfSchemas, boolean showIds, String aSchema, LineWriter html) throws IOException {
        ...
        html.writeln("<html>");
        html.writeln("<head>");
        html.write("  <title>SchemaSpy - Database ");
        html.write(databaseName);
        html.writeln("</title>");
        html.write("  <link rel=stylesheet href='");
        html.write(aSchema);
        html.writeln("/schemaSpy.css' type='text/css'>");
        html.writeln("  <meta HTTP-EQUIV='Content-Type' CONTENT='text/html; charset=ISO-8859-1'>");
        html.writeln("</head>");
        html.writeln("<body>");
        ...
        html.write("SchemaSpy Analysis of Database ");
        html.write(databaseName);
        html.writeln("</h1></td>");
        ...
        html.writeln(":</b>");
        html.writeln("<TABLE class='dataTable' border='1'>");
        html.writeln("<thead align='left'>");
        html.writeln("<tr>");
        html.writeln("  <th valign='bottom'>Schema</th>");
        if (showIds)
