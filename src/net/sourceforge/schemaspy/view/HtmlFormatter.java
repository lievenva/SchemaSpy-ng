...
public class HtmlFormatter {
    protected void writeHeader(Database db, Table table, String text, boolean showRelationships, boolean showOrphans, LineWriter out) throws IOException {
    ...
    protected void writeGeneratedBy(Database db, LineWriter html) throws IOException {
