...
public class HtmlFormatter {
    protected void writeHeader(Database db, Table table, String text, LineWriter out) throws IOException {
        ...
        out.writeln("</h1></td>");
        out.writeln("  <td class='heading' align='right' valign='top' title='Creator of Cool Tools'>by <span class='signature'><a href='mailto:currier_john@yahoo.com'>John Currier</a></span></td>");
        out.writeln(" </tr>");
        out.writeln("</table>");
        if (table == null) {
            out.write("Generated by <a href='mailto:currier_john@yahoo.com'>Currier</a>'s <b><i>SchemaSpy</i></b> on ");
    ...
    protected void writeLegend(boolean tableDetails, LineWriter out) throws IOException {
        ...
        if (tableDetails)
            out.writeln("   <tr class='dataTable'><td class='impliedRelationship'>Implied relationships</i></tr>");
